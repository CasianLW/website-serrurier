...
const ServicesComponent: FC = () => {
    ...
    const handleItemClick = (e: any, index: any) => {
        console.log(e.pageX);
        console.log(e.pageY);
        setActiveIndex(index);
        let infoBulle = document.querySelectorAll(".info-bulle")[index] as HTMLElement

        infoBulle.style.left = e.pageX
        infoBulle.style.bottom = e.pageY
            ...
            <div className="container">
                <Splide aria-label="Serrurier services" options={ {
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 1 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 1)} onMouseEnter={() => handleItemHover(1)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 2 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 2)} onMouseEnter={() => handleItemHover(2)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 3 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 3)} onMouseEnter={() => handleItemHover(3)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 4 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 4)} onMouseEnter={() => handleItemHover(4)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 5 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 5)} onMouseEnter={() => handleItemHover(5)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 6 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 6)} onMouseEnter={() => handleItemHover(6)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 7 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 7)} onMouseEnter={() => handleItemHover(7)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 8 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 8)} onMouseEnter={() => handleItemHover(8)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 9 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 9)} onMouseEnter={() => handleItemHover(9)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 10 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 10)} onMouseEnter={() => handleItemHover(10)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 11 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 11)} onMouseEnter={() => handleItemHover(11)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 12 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 12)} onMouseEnter={() => handleItemHover(12)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 13 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 13)} onMouseEnter={() => handleItemHover(13)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 14 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 14)} onMouseEnter={() => handleItemHover(14)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                       ...
                       <div className={`bullet ${activeIndex === 15 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 15)} onMouseEnter={() => handleItemHover(15)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 16 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 16)} onMouseEnter={() => handleItemHover(16)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 17 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 17)} onMouseEnter={() => handleItemHover(17)} onMouseLeave={handleItemLeave}>
                    ...
                    <SplideSlide>
                        ...
                        <div className={`bullet ${activeIndex === 18 ? 'active' : ''}`} onClick={(e) => handleItemClick(e, 18)} onMouseEnter={() => handleItemHover(18)} onMouseLeave={handleItemLeave}>
